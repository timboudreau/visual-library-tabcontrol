...
public class TabsAppearance {
    ...
    static final UIColorSupplier selectedBase
    ...
    static final UIColorSupplier selectedHl
            = selectedBase
                    .withBrightnessFrom(Colors.fromUIManager(Color.GRAY, "control"))
    ...
    static final UIColorSupplier hoveredHl
    ...
    static final UIColorSupplier hoveredBase
    ...
    static UIColorSupplier baseColor
    ...
    static UIColorSupplier baseHl = Colors.fromUIManager(base, "control").darkenBy(0.25f);

    private static final UIColorSupplier miniHighlight
...
//            Colors.fromUIManager(Color.BLUE.brighter(), "TabbedPane.focus");
    private static final UIColorSupplier miniHighlightEnd = miniHighlight.withAlpha(0);

    static UIColorSupplier selectedForeground
    ...
    private static UIColorSupplier defaultGlowDark
...
//            .cache();
    ...
    private static final UIColorSupplier directionFallback
    ...
    private static UIColorSupplier textFallback = Colors.fixed(Color.BLACK).unless(isDark, Colors.fixed(Color.WHITE));
    private static UIColorSupplier defaultUnselectedForeground
...
//        }
    ...
    private static final UIColorSupplier buttonOutline = Colors.fromUIManager(Color.DARK_GRAY, "controlDkShadow");
    private static final UIColorSupplier buttonOuterNormal
            = defaultGlowDark
                    .brightenBy(0.3725f).cache();
    private static final UIColorSupplier buttonCenterNormal = buttonOuterNormal.darkenBy(0.125f).cache();
    private static final UIColorSupplier buttonCenterHovered
